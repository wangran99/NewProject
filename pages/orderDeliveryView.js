...
import OrderDeliveryTabView from './orderDeliveryTabView'
...
type Props = {};
export default class orderDeliveryView extends Component<Props> {
    ...
    render() {
        ...
        return (
            ...
            >
                <OrderDeliveryTabView tabLabel='未完成' navig={this.props.navigation} status={3}></OrderDeliveryTabView>
                <OrderDeliveryTabView tabLabel='已完成' navig={this.props.navigation} status={1}></OrderDeliveryTabView>
                <OrderDeliveryTabView tabLabel='已取消' navig={this.props.navigation} status={2}></OrderDeliveryTabView>
                <OrderDeliveryTabView tabLabel='全部工单' navig={this.props.navigation} status={0}></OrderDeliveryTabView>
            </ScrollableTabView>
        );
    }
}
...
//输出一个类
module.exports = orderDeliveryView;