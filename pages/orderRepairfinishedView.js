...
type Props = {};
export default class orderRepairfinishedView extends Component<Props> {
    ...
    _getOrderRepairList() {
        httpApi.getOrderRepairList(this.pageIndex, 1).then(data => {
            if (this.pageIndex == 1)
                this.setState({ data });
...
//输出一个类
module.exports = orderRepairfinishedView;