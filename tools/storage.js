...
var local = {
    ...
    set(key, data, expires, id) {
        ...
        console.log("storage, key:" + key + " value:" + setValue);
        if (id) {
            storage.save({
                key: key,
                id: id,
            ...
            storage.save({
                ...
                console.warn("storage save error。key:" + key + ",data:" + data);
                reject(err);
            })
        }
    ...
    get(key, id) {
        if (id) {
            return storage.load({
                ...
                console.warn("storage get error。key:" + key + ",reason:" + JSON.stringify(err));
                /**
                 * 抛出错误
                 * 注释部分为抛出详细错误
                 * */
            ...
            return storage.load({
                ...
                console.warn("storage not found key:" + key + JSON.stringify(err));
                reject(err);
                /**
                 * 抛出错误
                 * 注释部分为抛出详细错误
